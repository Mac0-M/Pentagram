...
// Sync profile score and rank from GameStats
...
// 9. LEADERBOARD FRIEND SCORES (FROM MongoDB Profiles and GameStats)
app.get('/api/get-friend-scores', async (req, res) => {
    try {
        const profiles = await Profile.find({});
        const friendScores = [];
        ...
        for (const profile of profiles) {
            ...
            // Find all game stats for this user
